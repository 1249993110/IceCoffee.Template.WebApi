INSERT INTO T_User(Id,Name,DisplayName,PasswordHash,PasswordSalt,LoginEnabled) VALUES('6474EFE2-7C58-9C1B-8A89-88C898CB543A','admin','系统管理员','Xg9+QTHDb5Mw9vaEe9q8PqvlZqE=','NCPuMnV9WlfswrYk42cENwKP2mU/K9IJ',true);
...
INSERT INTO T_Menu(Id,ParentId,Name,Sort,Url,IsEnabled) VALUES('F1FB0526-CB1E-FCA8-2754-5868EFF0194B',null,'主页',0,'/home',true);
INSERT INTO T_Menu(Id,ParentId,Name,Sort,Url,IsEnabled) VALUES('BB106982-0F6E-BFD8-F668-FE622FA6195A',null,'系统管理',99,null,true);
INSERT INTO T_Menu(Id,ParentId,Name,Sort,Url,IsEnabled) VALUES('ABC2607E-3EA6-D730-BB2C-7C8B3C213E88',(SELECT Id FROM T_Menu WHERE Name='系统管理'),'用户管理',1,'/system-management/users',true);
